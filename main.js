...
$(document).ready(function () {
    ...
    var addCard = function(item, id) {
            ...
            let $newCard = $(
                `<div class="card" data-original="${item.Poster}" data-genre="${item.Genre}" id="${id}" style="height: ${cardHeight}px; width: ${cardWidth}px; background-image: url(${item.Poster};">
            ...
            let cardMenu = $('.card').find('.card-menu#' + id);
